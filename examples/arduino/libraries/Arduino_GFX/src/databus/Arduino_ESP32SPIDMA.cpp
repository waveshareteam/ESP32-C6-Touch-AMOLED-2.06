...
bool Arduino_ESP32SPIDMA::begin(int32_t speed, int8_t dataMode)
{
  ...
  // Arduino-ESP32 3.3.6 changed spiFrequencyToClockDiv() to require an SPI
  // instance. DMA mode passes _speed directly to the ESP-IDF driver, so _div
  // is unused and the legacy calculation can be skipped on newer cores.
